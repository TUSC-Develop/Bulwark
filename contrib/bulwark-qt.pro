...
RESOURCES += src/qt/tusc.qrc src/qt/tusc_locale.qrc

TRANSLATIONS += src/qt/locale/tusc_bg.ts \
                src/qt/locale/tusc_de.ts \
                src/qt/locale/tusc_en.ts \
                src/qt/locale/tusc_es.ts \
                src/qt/locale/tusc_fi.ts \
                src/qt/locale/tusc_fr.ts \
                src/qt/locale/tusc_it.ts \
                src/qt/locale/tusc_ja.ts \
                src/qt/locale/tusc_pl.ts \
                src/qt/locale/tusc_pt.ts \
                src/qt/locale/tusc_ru.ts \
                src/qt/locale/tusc_sk.ts \
                src/qt/locale/tusc_sv.ts \
                src/qt/locale/tusc_vi.ts \
                src/qt/locale/tusc_zh_CN.ts \
                src/qt/locale/tusc_zh_TW.ts
