Contributing to Tusc Core
============================

The Tusc Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Tusc Core project, and is not to be
confused with overall Tusc Network Protocol consensus changes.

Whether a pull request is merged into Tusc Core rests with the project merge
...
Patches that change Tusc consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tusc consensus, it must have been
...
The project leader is the release manager for each Tusc Core release.
