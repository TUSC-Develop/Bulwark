...
This mechanism has been integrated into Bitcore-Node-TUSC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/tusc-crypto/insight-api-tusc#web-socket-api](https://github.com/tusc-crypto/insight-api-tusc#web-socket-api) 
* API: [https://github.com/tusc-crypto/insight-api-tusc#swifttx-transactions](https://github.com/tusc-crypto/insight-api-tusc#swifttx-transactions) 
...
By default, the TUSC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TUSC Core daemon:
