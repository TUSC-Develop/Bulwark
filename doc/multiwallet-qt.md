...
In order to support loading of multiple wallets in tusc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tusc.cpp.
...
Changes to tusc.cpp
----------------------
tusc.cpp is the entry point into tusc-qt, and as such, will require some minor modifications to provide hooks for
